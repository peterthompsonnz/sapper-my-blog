<svelte:head>
	<title>Happy Duckies: About</title>
</svelte:head>

<h1>About this site</h1>
<p>The name of this site is <strong>Happy Duckies</strong>. This is a totally random name that I thought up when I found on <strong>unsplash</strong> the duckies image that is displayed on the home page. Every homepage has to have some sort of an image - right? The fact that I chose one that has nothing to do with the content of the site is neither here nor there.</p>
<p>The site is built using <strong>Svelte/Sapper</strong>. I built it to learn how to use Sapper and also to host some of the programs that I have made over the years.</p>
